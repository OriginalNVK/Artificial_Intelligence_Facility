...
for result in results:
    ...
    print(f"  Execution time: {result['ucs']['execution_time']} nanoseconds")
    ...
    print(f"  Execution time: {result['dfs']['execution_time']} nanoseconds")
    ...
    print(f"  Execution time: {result['bfs']['execution_time']} nanoseconds")
    ...
    print(f"  Execution time: {result['astar']['execution_time']} nanoseconds")
